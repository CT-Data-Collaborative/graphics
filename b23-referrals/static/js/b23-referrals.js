$(document).ready(function(){
    ...
    d3.csv("static/data/referrals.csv", function(data) {
        const DATA = data.map(function(o) {
            return {
                "Town" : o["Town"],
                "Year" : dateFormat.parse(o["Year"]),
                "Referrals" : parseInt(o["Value"])
            };
        });
        ...
        function drawChart(container_width) {
            ...
            var yDomain = d3.extent(DATA.map(function(d) {
                return d["Referrals"];
            }));
            ...
            if (container_width <= mobile_threshold) {
                yAxisLabel
                  .attr("dx", "0.5em")
                  .attr("dy", "0.1em")
            } else if (container_width > mobile_threshold) {
                yAxisLabel
                  .attr("dy", "1em")
                    .attr("dx", "0.25em")
            ...
            Object.keys(classNames).forEach(function(town) {
                ...
                var lineFunction = d3.svg.line()
                    ...
                    .y(function(d) { return y(d["Referrals"]); })
            ...
            hoverGroups.each(function(pointData, i) {
                ...
                var points = group.selectAll("path.point")
                    ...
                    .append("path")
                        ...
                        .attr("transform", function(d) { return "translate(" + x(d["Year"]) + ", " + y(d["Referrals"]) +")";})

                pointData.map(function(town) {
                    // make text labels
                    var valueText = [
                        town["Town"],
                        numberFormat(town["Referrals"])
                    ];
